...
const CreateActivity = () => {
  ...
  axios.get(`https://capstone-admin-taskhub-1.onrender.com/api/class/${classId}`),
  axios.get(`https://capstone-admin-taskhub-1.onrender.com/api/activities?classId=${classId}`)
      ]);
  ...
  await axios.post(`https://capstone-admin-taskhub-1.onrender.com/api/activities`, formData, { headers: { 'Content-Type': 'multipart/form-data' } });
